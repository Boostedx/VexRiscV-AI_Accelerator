...
// SystemVerilog created from bb_myproject_B2_sr_0
...
module myproject_bb_B2_sr_0 (
    input wire [0:0] in_i_stall,
    input wire [0:0] in_i_valid,
    input wire [0:0] in_i_data_0_tpl,
    input wire [40:0] in_i_data_1_tpl,
    ...
    output wire [40:0] out_o_data_1_tpl,
    ...
    reg [40:0] data_mux_1_x_q;
    wire [0:0] data_mux_2_x_s;
    reg [40:0] data_mux_2_x_q;
    wire [0:0] data_mux_3_x_s;
    reg [40:0] data_mux_3_x_q;
    wire [0:0] data_mux_4_x_s;
    reg [40:0] data_mux_4_x_q;
    wire [0:0] data_mux_5_x_s;
    reg [40:0] data_mux_5_x_q;
    wire [0:0] data_mux_6_x_s;
    reg [40:0] data_mux_6_x_q;
    wire [0:0] data_mux_7_x_s;
    reg [40:0] data_mux_7_x_q;
    wire [0:0] data_mux_8_x_s;
    reg [40:0] data_mux_8_x_q;
    wire [0:0] data_mux_9_x_s;
    reg [40:0] data_mux_9_x_q;
    wire [0:0] data_mux_10_x_s;
    reg [40:0] data_mux_10_x_q;
    wire [0:0] data_mux_11_x_s;
    reg [40:0] data_mux_11_x_q;
    wire [0:0] data_mux_12_x_s;
    reg [40:0] data_mux_12_x_q;
    wire [0:0] data_mux_13_x_s;
    reg [40:0] data_mux_13_x_q;
    wire [0:0] data_mux_14_x_s;
    reg [40:0] data_mux_14_x_q;
    wire [0:0] data_mux_15_x_s;
    reg [40:0] data_mux_15_x_q;
    wire [0:0] data_mux_16_x_s;
    reg [40:0] data_mux_16_x_q;
    wire [0:0] data_mux_17_x_s;
    reg [40:0] data_mux_17_x_q;
    wire [0:0] data_mux_18_x_s;
    reg [40:0] data_mux_18_x_q;
    wire [0:0] data_mux_19_x_s;
    reg [40:0] data_mux_19_x_q;
    wire [0:0] data_mux_20_x_s;
    reg [40:0] data_mux_20_x_q;
    wire [0:0] data_mux_21_x_s;
    reg [40:0] data_mux_21_x_q;
    wire [0:0] data_mux_22_x_s;
    reg [40:0] data_mux_22_x_q;
    wire [0:0] data_mux_23_x_s;
    reg [40:0] data_mux_23_x_q;
    wire [0:0] data_mux_24_x_s;
    reg [40:0] data_mux_24_x_q;
    wire [0:0] data_mux_25_x_s;
    reg [40:0] data_mux_25_x_q;
    wire [0:0] data_mux_26_x_s;
    reg [40:0] data_mux_26_x_q;
    wire [0:0] data_mux_27_x_s;
    reg [40:0] data_mux_27_x_q;
    wire [0:0] data_mux_28_x_s;
    reg [40:0] data_mux_28_x_q;
    wire [0:0] data_mux_29_x_s;
    reg [40:0] data_mux_29_x_q;
    wire [0:0] data_mux_30_x_s;
    reg [40:0] data_mux_30_x_q;
    wire [0:0] data_mux_31_x_s;
    reg [40:0] data_mux_31_x_q;
    wire [0:0] data_mux_32_x_s;
    reg [40:0] data_mux_32_x_q;
    reg [0:0] sr_0_x_q;
    reg [40:0] sr_1_x_q;
    reg [40:0] sr_2_x_q;
    reg [40:0] sr_3_x_q;
    ...
    // out_o_stall(GPOUT,75)
    assign out_o_stall = sr_valid_q;

    // out_o_valid(GPOUT,76)
    ...
    begin
        if (!resetn)
        begin
            sr_1_x_q <= $unsigned(41'b00000000000000000000000000000000000000000);
        end
        else if (not_sr_valid_q == 1'b1)
        begin
    ...
    begin
        unique case (data_mux_1_x_s)
            ...
            default : data_mux_1_x_q = 41'b0;
        endcase
    end

    // out_o_data_1_tpl(GPOUT,78)
    ...
    begin
        if (!resetn)
        begin
            sr_2_x_q <= $unsigned(41'b00000000000000000000000000000000000000000);
        end
        else if (not_sr_valid_q == 1'b1)
        begin
    ...
    begin
        unique case (data_mux_2_x_s)
            ...
            default : data_mux_2_x_q = 41'b0;
        endcase
    end

    // out_o_data_2_tpl(GPOUT,79)
    ...
    begin
        if (!resetn)
        begin
            sr_3_x_q <= $unsigned(41'b00000000000000000000000000000000000000000);
        end
        else if (not_sr_valid_q == 1'b1)
        begin
    ...
    begin
        unique case (data_mux_3_x_s)
            ...
            default : data_mux_3_x_q = 41'b0;
        endcase
    end

    // out_o_data_3_tpl(GPOUT,80)
    ...
    begin
        if (!resetn)
        begin
            sr_4_x_q <= $unsigned(41'b00000000000000000000000000000000000000000);
        end
        else if (not_sr_valid_q == 1'b1)
        begin
    ...
    begin
        unique case (data_mux_4_x_s)
            ...
            default : data_mux_4_x_q = 41'b0;
        endcase
    end

    // out_o_data_4_tpl(GPOUT,81)
    ...
    begin
        if (!resetn)
        begin
            sr_5_x_q <= $unsigned(41'b00000000000000000000000000000000000000000);
        end
        else if (not_sr_valid_q == 1'b1)
        begin
    ...
    begin
        unique case (data_mux_5_x_s)
            ...
            default : data_mux_5_x_q = 41'b0;
        endcase
    end

    // out_o_data_5_tpl(GPOUT,82)
    ...
    begin
        if (!resetn)
        begin
            sr_6_x_q <= $unsigned(41'b00000000000000000000000000000000000000000);
        end
        else if (not_sr_valid_q == 1'b1)
        begin
    ...
    begin
        unique case (data_mux_6_x_s)
            ...
            default : data_mux_6_x_q = 41'b0;
        endcase
    end

    // out_o_data_6_tpl(GPOUT,83)
    ...
    begin
        if (!resetn)
        begin
            sr_7_x_q <= $unsigned(41'b00000000000000000000000000000000000000000);
        end
        else if (not_sr_valid_q == 1'b1)
        begin
    ...
    begin
        unique case (data_mux_7_x_s)
            ...
            default : data_mux_7_x_q = 41'b0;
        endcase
    end

    // out_o_data_7_tpl(GPOUT,84)
    ...
    begin
        if (!resetn)
        begin
            sr_8_x_q <= $unsigned(41'b00000000000000000000000000000000000000000);
        end
        else if (not_sr_valid_q == 1'b1)
        begin
    ...
    begin
        unique case (data_mux_8_x_s)
            ...
            default : data_mux_8_x_q = 41'b0;
        endcase
    end

    // out_o_data_8_tpl(GPOUT,85)
    ...
    begin
        if (!resetn)
        begin
            sr_9_x_q <= $unsigned(41'b00000000000000000000000000000000000000000);
        end
        else if (not_sr_valid_q == 1'b1)
        begin
    ...
    begin
        unique case (data_mux_9_x_s)
            ...
            default : data_mux_9_x_q = 41'b0;
        endcase
    end

    // out_o_data_9_tpl(GPOUT,86)
    ...
    begin
        if (!resetn)
        begin
            sr_10_x_q <= $unsigned(41'b00000000000000000000000000000000000000000);
        end
        else if (not_sr_valid_q == 1'b1)
        begin
    ...
    begin
        unique case (data_mux_10_x_s)
            ...
            default : data_mux_10_x_q = 41'b0;
        endcase
    end

    // out_o_data_10_tpl(GPOUT,87)
    ...
    begin
        if (!resetn)
        begin
            sr_11_x_q <= $unsigned(41'b00000000000000000000000000000000000000000);
        end
        else if (not_sr_valid_q == 1'b1)
        begin
    ...
    begin
        unique case (data_mux_11_x_s)
            ...
            default : data_mux_11_x_q = 41'b0;
        endcase
    end

    // out_o_data_11_tpl(GPOUT,88)
    ...
    begin
        if (!resetn)
        begin
            sr_12_x_q <= $unsigned(41'b00000000000000000000000000000000000000000);
        end
        else if (not_sr_valid_q == 1'b1)
        begin
    ...
    begin
        unique case (data_mux_12_x_s)
            ...
            default : data_mux_12_x_q = 41'b0;
        endcase
    end

    // out_o_data_12_tpl(GPOUT,89)
    ...
    begin
        if (!resetn)
        begin
            sr_13_x_q <= $unsigned(41'b00000000000000000000000000000000000000000);
        end
        else if (not_sr_valid_q == 1'b1)
        begin
    ...
    begin
        unique case (data_mux_13_x_s)
            ...
            default : data_mux_13_x_q = 41'b0;
        endcase
    end

    // out_o_data_13_tpl(GPOUT,90)
    ...
    begin
        if (!resetn)
        begin
            sr_14_x_q <= $unsigned(41'b00000000000000000000000000000000000000000);
        end
        else if (not_sr_valid_q == 1'b1)
        begin
    ...
    begin
        unique case (data_mux_14_x_s)
            ...
            default : data_mux_14_x_q = 41'b0;
        endcase
    end

    // out_o_data_14_tpl(GPOUT,91)
    ...
    begin
        if (!resetn)
        begin
            sr_15_x_q <= $unsigned(41'b00000000000000000000000000000000000000000);
        end
        else if (not_sr_valid_q == 1'b1)
        begin
    ...
    begin
        unique case (data_mux_15_x_s)
            ...
            default : data_mux_15_x_q = 41'b0;
        endcase
    end

    // out_o_data_15_tpl(GPOUT,92)
    ...
    begin
        if (!resetn)
        begin
            sr_16_x_q <= $unsigned(41'b00000000000000000000000000000000000000000);
        end
        else if (not_sr_valid_q == 1'b1)
        begin
    ...
    begin
        unique case (data_mux_16_x_s)
            ...
            default : data_mux_16_x_q = 41'b0;
        endcase
    end

    // out_o_data_16_tpl(GPOUT,93)
    ...
    begin
        if (!resetn)
        begin
            sr_17_x_q <= $unsigned(41'b00000000000000000000000000000000000000000);
        end
        else if (not_sr_valid_q == 1'b1)
        begin
    ...
    begin
        unique case (data_mux_17_x_s)
            ...
            default : data_mux_17_x_q = 41'b0;
        endcase
    end

    // out_o_data_17_tpl(GPOUT,94)
    ...
    begin
        if (!resetn)
        begin
            sr_18_x_q <= $unsigned(41'b00000000000000000000000000000000000000000);
        end
        else if (not_sr_valid_q == 1'b1)
        begin
    ...
    begin
        unique case (data_mux_18_x_s)
            ...
            default : data_mux_18_x_q = 41'b0;
        endcase
    end

    // out_o_data_18_tpl(GPOUT,95)
    ...
    begin
        if (!resetn)
        begin
            sr_19_x_q <= $unsigned(41'b00000000000000000000000000000000000000000);
        end
        else if (not_sr_valid_q == 1'b1)
        begin
    ...
    begin
        unique case (data_mux_19_x_s)
            ...
            default : data_mux_19_x_q = 41'b0;
        endcase
    end

    // out_o_data_19_tpl(GPOUT,96)
    ...
    begin
        if (!resetn)
        begin
            sr_20_x_q <= $unsigned(41'b00000000000000000000000000000000000000000);
        end
        else if (not_sr_valid_q == 1'b1)
        begin
    ...
    begin
        unique case (data_mux_20_x_s)
            ...
            default : data_mux_20_x_q = 41'b0;
        endcase
    end

    // out_o_data_20_tpl(GPOUT,97)
    ...
    begin
        if (!resetn)
        begin
            sr_21_x_q <= $unsigned(41'b00000000000000000000000000000000000000000);
        end
        else if (not_sr_valid_q == 1'b1)
        begin
    ...
    begin
        unique case (data_mux_21_x_s)
            ...
            default : data_mux_21_x_q = 41'b0;
        endcase
    end

    // out_o_data_21_tpl(GPOUT,98)
    ...
    begin
        if (!resetn)
        begin
            sr_22_x_q <= $unsigned(41'b00000000000000000000000000000000000000000);
        end
        else if (not_sr_valid_q == 1'b1)
        begin
    ...
    begin
        unique case (data_mux_22_x_s)
            ...
            default : data_mux_22_x_q = 41'b0;
        endcase
    end

    // out_o_data_22_tpl(GPOUT,99)
    ...
    begin
        if (!resetn)
        begin
            sr_23_x_q <= $unsigned(41'b00000000000000000000000000000000000000000);
        end
        else if (not_sr_valid_q == 1'b1)
        begin
    ...
    begin
        unique case (data_mux_23_x_s)
            ...
            default : data_mux_23_x_q = 41'b0;
        endcase
    end

    // out_o_data_23_tpl(GPOUT,100)
    ...
    begin
        if (!resetn)
        begin
            sr_24_x_q <= $unsigned(41'b00000000000000000000000000000000000000000);
        end
        else if (not_sr_valid_q == 1'b1)
        begin
    ...
    begin
        unique case (data_mux_24_x_s)
            ...
            default : data_mux_24_x_q = 41'b0;
        endcase
    end

    // out_o_data_24_tpl(GPOUT,101)
    ...
    begin
        if (!resetn)
        begin
            sr_25_x_q <= $unsigned(41'b00000000000000000000000000000000000000000);
        end
        else if (not_sr_valid_q == 1'b1)
        begin
    ...
    begin
        unique case (data_mux_25_x_s)
            ...
            default : data_mux_25_x_q = 41'b0;
        endcase
    end

    // out_o_data_25_tpl(GPOUT,102)
    ...
    begin
        if (!resetn)
        begin
            sr_26_x_q <= $unsigned(41'b00000000000000000000000000000000000000000);
        end
        else if (not_sr_valid_q == 1'b1)
        begin
    ...
    begin
        unique case (data_mux_26_x_s)
            ...
            default : data_mux_26_x_q = 41'b0;
        endcase
    end

    // out_o_data_26_tpl(GPOUT,103)
    ...
    begin
        if (!resetn)
        begin
            sr_27_x_q <= $unsigned(41'b00000000000000000000000000000000000000000);
        end
        else if (not_sr_valid_q == 1'b1)
        begin
    ...
    begin
        unique case (data_mux_27_x_s)
            ...
            default : data_mux_27_x_q = 41'b0;
        endcase
    end

    // out_o_data_27_tpl(GPOUT,104)
    ...
    begin
        if (!resetn)
        begin
            sr_28_x_q <= $unsigned(41'b00000000000000000000000000000000000000000);
        end
        else if (not_sr_valid_q == 1'b1)
        begin
    ...
    begin
        unique case (data_mux_28_x_s)
            ...
            default : data_mux_28_x_q = 41'b0;
        endcase
    end

    // out_o_data_28_tpl(GPOUT,105)
    ...
    begin
        if (!resetn)
        begin
            sr_29_x_q <= $unsigned(41'b00000000000000000000000000000000000000000);
        end
        else if (not_sr_valid_q == 1'b1)
        begin
    ...
    begin
        unique case (data_mux_29_x_s)
            ...
            default : data_mux_29_x_q = 41'b0;
        endcase
    end

    // out_o_data_29_tpl(GPOUT,106)
    ...
    begin
        if (!resetn)
        begin
            sr_30_x_q <= $unsigned(41'b00000000000000000000000000000000000000000);
        end
        else if (not_sr_valid_q == 1'b1)
        begin
    ...
    begin
        unique case (data_mux_30_x_s)
            ...
            default : data_mux_30_x_q = 41'b0;
        endcase
    end

    // out_o_data_30_tpl(GPOUT,107)
    ...
    begin
        if (!resetn)
        begin
            sr_31_x_q <= $unsigned(41'b00000000000000000000000000000000000000000);
        end
        else if (not_sr_valid_q == 1'b1)
        begin
    ...
    begin
        unique case (data_mux_31_x_s)
            ...
            default : data_mux_31_x_q = 41'b0;
        endcase
    end

    // out_o_data_31_tpl(GPOUT,108)
    ...
    begin
        if (!resetn)
        begin
            sr_32_x_q <= $unsigned(41'b00000000000000000000000000000000000000000);
        end
        else if (not_sr_valid_q == 1'b1)
        begin
    ...
    begin
        unique case (data_mux_32_x_s)
            ...
            default : data_mux_32_x_q = 41'b0;
        endcase
    end

    // out_o_data_32_tpl(GPOUT,109)
