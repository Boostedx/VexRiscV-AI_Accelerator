...
// SystemVerilog created from bb_myproject_B3_sr_0
...
module myproject_bb_B3_sr_0 (
    input wire [0:0] in_i_stall,
    input wire [0:0] in_i_valid,
    input wire [23:0] in_i_data_0_tpl,
    ...
    output wire [23:0] out_o_data_0_tpl,
    ...
    reg [23:0] data_mux_0_x_q;
    wire [0:0] data_mux_1_x_s;
    reg [23:0] data_mux_1_x_q;
    wire [0:0] data_mux_2_x_s;
    reg [23:0] data_mux_2_x_q;
    wire [0:0] data_mux_3_x_s;
    reg [23:0] data_mux_3_x_q;
    wire [0:0] data_mux_4_x_s;
    reg [23:0] data_mux_4_x_q;
    wire [0:0] data_mux_5_x_s;
    reg [23:0] data_mux_5_x_q;
    wire [0:0] data_mux_6_x_s;
    reg [23:0] data_mux_6_x_q;
    wire [0:0] data_mux_7_x_s;
    reg [23:0] data_mux_7_x_q;
    wire [0:0] data_mux_8_x_s;
    reg [23:0] data_mux_8_x_q;
    wire [0:0] data_mux_9_x_s;
    reg [23:0] data_mux_9_x_q;
    reg [23:0] sr_0_x_q;
    reg [23:0] sr_1_x_q;
    reg [23:0] sr_2_x_q;
    reg [23:0] sr_3_x_q;
    ...
    begin
        if (!resetn)
        begin
            sr_0_x_q <= $unsigned(24'b000000000000000000000000);
        end
    ...
    begin
        if (!resetn)
        begin
            sr_1_x_q <= $unsigned(24'b000000000000000000000000);
        end
        else if (not_sr_valid_q == 1'b1)
        begin
    ...
    begin
        if (!resetn)
        begin
            sr_2_x_q <= $unsigned(24'b000000000000000000000000);
        end
        else if (not_sr_valid_q == 1'b1)
        begin
    ...
    begin
        if (!resetn)
        begin
            sr_3_x_q <= $unsigned(24'b000000000000000000000000);
        end
        else if (not_sr_valid_q == 1'b1)
        begin
    ...
    begin
        if (!resetn)
        begin
            sr_4_x_q <= $unsigned(24'b000000000000000000000000);
        end
        else if (not_sr_valid_q == 1'b1)
        begin
    ...
    begin
        if (!resetn)
        begin
            sr_5_x_q <= $unsigned(24'b000000000000000000000000);
        end
        else if (not_sr_valid_q == 1'b1)
        begin
    ...
    begin
        if (!resetn)
        begin
            sr_6_x_q <= $unsigned(24'b000000000000000000000000);
        end
        else if (not_sr_valid_q == 1'b1)
        begin
    ...
    begin
        if (!resetn)
        begin
            sr_7_x_q <= $unsigned(24'b000000000000000000000000);
        end
        else if (not_sr_valid_q == 1'b1)
        begin
    ...
    begin
        if (!resetn)
        begin
            sr_8_x_q <= $unsigned(24'b000000000000000000000000);
        end
        else if (not_sr_valid_q == 1'b1)
        begin
    ...
    begin
        if (!resetn)
        begin
            sr_9_x_q <= $unsigned(24'b000000000000000000000000);
        end
        else if (not_sr_valid_q == 1'b1)
        begin
