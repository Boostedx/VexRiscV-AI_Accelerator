...
// SystemVerilog created from bb_myproject_B4_sr_1
...
module myproject_bb_B4_sr_1 (
    ...
    input wire [15:0] in_i_data_11_tpl,
    input wire [15:0] in_i_data_12_tpl,
    input wire [15:0] in_i_data_13_tpl,
    input wire [15:0] in_i_data_14_tpl,
    input wire [15:0] in_i_data_15_tpl,
    input wire [15:0] in_i_data_16_tpl,
    input wire [15:0] in_i_data_17_tpl,
    input wire [15:0] in_i_data_18_tpl,
    input wire [15:0] in_i_data_19_tpl,
    input wire [15:0] in_i_data_20_tpl,
    input wire [15:0] in_i_data_21_tpl,
    input wire [15:0] in_i_data_22_tpl,
    input wire [15:0] in_i_data_23_tpl,
    input wire [15:0] in_i_data_24_tpl,
    input wire [15:0] in_i_data_25_tpl,
    input wire [15:0] in_i_data_26_tpl,
    input wire [15:0] in_i_data_27_tpl,
    input wire [15:0] in_i_data_28_tpl,
    input wire [15:0] in_i_data_29_tpl,
    input wire [15:0] in_i_data_30_tpl,
    input wire [15:0] in_i_data_31_tpl,
    ...
    reg [15:0] data_mux_1_x_q;
    wire [0:0] data_mux_2_x_s;
    reg [15:0] data_mux_2_x_q;
    wire [0:0] data_mux_3_x_s;
    reg [15:0] data_mux_3_x_q;
    wire [0:0] data_mux_4_x_s;
    reg [15:0] data_mux_4_x_q;
    wire [0:0] data_mux_5_x_s;
    reg [15:0] data_mux_5_x_q;
    wire [0:0] data_mux_6_x_s;
    reg [15:0] data_mux_6_x_q;
    wire [0:0] data_mux_7_x_s;
    reg [15:0] data_mux_7_x_q;
    wire [0:0] data_mux_8_x_s;
    reg [15:0] data_mux_8_x_q;
    wire [0:0] data_mux_9_x_s;
    reg [15:0] data_mux_9_x_q;
    wire [0:0] data_mux_10_x_s;
    reg [15:0] data_mux_10_x_q;
    wire [0:0] data_mux_11_x_s;
    reg [15:0] data_mux_11_x_q;
    wire [0:0] data_mux_12_x_s;
    reg [15:0] data_mux_12_x_q;
    wire [0:0] data_mux_13_x_s;
    reg [15:0] data_mux_13_x_q;
    wire [0:0] data_mux_14_x_s;
    reg [15:0] data_mux_14_x_q;
    wire [0:0] data_mux_15_x_s;
    reg [15:0] data_mux_15_x_q;
    wire [0:0] data_mux_16_x_s;
    reg [15:0] data_mux_16_x_q;
    wire [0:0] data_mux_17_x_s;
    reg [15:0] data_mux_17_x_q;
    wire [0:0] data_mux_18_x_s;
    reg [15:0] data_mux_18_x_q;
    wire [0:0] data_mux_19_x_s;
    reg [15:0] data_mux_19_x_q;
    wire [0:0] data_mux_20_x_s;
    reg [15:0] data_mux_20_x_q;
    wire [0:0] data_mux_21_x_s;
    reg [15:0] data_mux_21_x_q;
    wire [0:0] data_mux_22_x_s;
    reg [15:0] data_mux_22_x_q;
    wire [0:0] data_mux_23_x_s;
    reg [15:0] data_mux_23_x_q;
    wire [0:0] data_mux_24_x_s;
    reg [15:0] data_mux_24_x_q;
    wire [0:0] data_mux_25_x_s;
    reg [15:0] data_mux_25_x_q;
    wire [0:0] data_mux_26_x_s;
    reg [15:0] data_mux_26_x_q;
    wire [0:0] data_mux_27_x_s;
    reg [15:0] data_mux_27_x_q;
    wire [0:0] data_mux_28_x_s;
    reg [15:0] data_mux_28_x_q;
    wire [0:0] data_mux_29_x_s;
    reg [15:0] data_mux_29_x_q;
    wire [0:0] data_mux_30_x_s;
    reg [15:0] data_mux_30_x_q;
    wire [0:0] data_mux_31_x_s;
    reg [15:0] data_mux_31_x_q;
    ...
    begin
        if (!resetn)
        begin
            sr_1_x_q <= $unsigned(16'b0000000000000000);
        end
        else if (not_sr_valid_q == 1'b1)
        begin
    ...
    begin
        if (!resetn)
        begin
            sr_2_x_q <= $unsigned(16'b0000000000000000);
        end
        else if (not_sr_valid_q == 1'b1)
        begin
    ...
    begin
        if (!resetn)
        begin
            sr_3_x_q <= $unsigned(16'b0000000000000000);
        end
        else if (not_sr_valid_q == 1'b1)
        begin
    ...
    begin
        if (!resetn)
        begin
            sr_4_x_q <= $unsigned(16'b0000000000000000);
        end
        else if (not_sr_valid_q == 1'b1)
        begin
    ...
    begin
        if (!resetn)
        begin
            sr_5_x_q <= $unsigned(16'b0000000000000000);
        end
        else if (not_sr_valid_q == 1'b1)
        begin
    ...
    begin
        if (!resetn)
        begin
            sr_6_x_q <= $unsigned(16'b0000000000000000);
        end
        else if (not_sr_valid_q == 1'b1)
        begin
    ...
    begin
        if (!resetn)
        begin
            sr_7_x_q <= $unsigned(16'b0000000000000000);
        end
        else if (not_sr_valid_q == 1'b1)
        begin
    ...
    begin
        if (!resetn)
        begin
            sr_8_x_q <= $unsigned(16'b0000000000000000);
        end
        else if (not_sr_valid_q == 1'b1)
        begin
    ...
    begin
        if (!resetn)
        begin
            sr_9_x_q <= $unsigned(16'b0000000000000000);
        end
        else if (not_sr_valid_q == 1'b1)
        begin
    ...
    begin
        if (!resetn)
        begin
            sr_10_x_q <= $unsigned(16'b0000000000000000);
        end
        else if (not_sr_valid_q == 1'b1)
        begin
    ...
    begin
        if (!resetn)
        begin
            sr_11_x_q <= $unsigned(16'b0000000000000000);
        end
        else if (not_sr_valid_q == 1'b1)
        begin
    ...
    begin
        if (!resetn)
        begin
            sr_12_x_q <= $unsigned(16'b0000000000000000);
        end
        else if (not_sr_valid_q == 1'b1)
        begin
    ...
    begin
        if (!resetn)
        begin
            sr_13_x_q <= $unsigned(16'b0000000000000000);
        end
        else if (not_sr_valid_q == 1'b1)
        begin
    ...
    begin
        if (!resetn)
        begin
            sr_14_x_q <= $unsigned(16'b0000000000000000);
        end
        else if (not_sr_valid_q == 1'b1)
        begin
    ...
    begin
        if (!resetn)
        begin
            sr_15_x_q <= $unsigned(16'b0000000000000000);
        end
        else if (not_sr_valid_q == 1'b1)
        begin
    ...
    begin
        if (!resetn)
        begin
            sr_16_x_q <= $unsigned(16'b0000000000000000);
        end
        else if (not_sr_valid_q == 1'b1)
        begin
    ...
    begin
        if (!resetn)
        begin
            sr_17_x_q <= $unsigned(16'b0000000000000000);
        end
        else if (not_sr_valid_q == 1'b1)
        begin
    ...
    begin
        if (!resetn)
        begin
            sr_18_x_q <= $unsigned(16'b0000000000000000);
        end
        else if (not_sr_valid_q == 1'b1)
        begin
    ...
    begin
        if (!resetn)
        begin
            sr_19_x_q <= $unsigned(16'b0000000000000000);
        end
        else if (not_sr_valid_q == 1'b1)
        begin
    ...
    begin
        if (!resetn)
        begin
            sr_20_x_q <= $unsigned(16'b0000000000000000);
        end
        else if (not_sr_valid_q == 1'b1)
        begin
    ...
    begin
        if (!resetn)
        begin
            sr_21_x_q <= $unsigned(16'b0000000000000000);
        end
        else if (not_sr_valid_q == 1'b1)
        begin
    ...
    begin
        if (!resetn)
        begin
            sr_22_x_q <= $unsigned(16'b0000000000000000);
        end
        else if (not_sr_valid_q == 1'b1)
        begin
    ...
    begin
        if (!resetn)
        begin
            sr_23_x_q <= $unsigned(16'b0000000000000000);
        end
        else if (not_sr_valid_q == 1'b1)
        begin
    ...
    begin
        if (!resetn)
        begin
            sr_24_x_q <= $unsigned(16'b0000000000000000);
        end
        else if (not_sr_valid_q == 1'b1)
        begin
    ...
    begin
        if (!resetn)
        begin
            sr_25_x_q <= $unsigned(16'b0000000000000000);
        end
        else if (not_sr_valid_q == 1'b1)
        begin
    ...
    begin
        if (!resetn)
        begin
            sr_26_x_q <= $unsigned(16'b0000000000000000);
        end
        else if (not_sr_valid_q == 1'b1)
        begin
    ...
    begin
        if (!resetn)
        begin
            sr_27_x_q <= $unsigned(16'b0000000000000000);
        end
        else if (not_sr_valid_q == 1'b1)
        begin
    ...
    begin
        if (!resetn)
        begin
            sr_28_x_q <= $unsigned(16'b0000000000000000);
        end
        else if (not_sr_valid_q == 1'b1)
        begin
    ...
    begin
        if (!resetn)
        begin
            sr_29_x_q <= $unsigned(16'b0000000000000000);
        end
        else if (not_sr_valid_q == 1'b1)
        begin
    ...
    begin
        if (!resetn)
        begin
            sr_30_x_q <= $unsigned(16'b0000000000000000);
        end
        else if (not_sr_valid_q == 1'b1)
        begin
    ...
    begin
        if (!resetn)
        begin
            sr_31_x_q <= $unsigned(16'b0000000000000000);
        end
        else if (not_sr_valid_q == 1'b1)
        begin
