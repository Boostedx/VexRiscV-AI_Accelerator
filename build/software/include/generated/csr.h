...
/* AI_ENGINE Registers */
#define CSR_AI_ENGINE_BASE (CSR_BASE + 0x0L)
#define CSR_AI_ENGINE_CONTROL_ADDR (CSR_BASE + 0x0L)
#define CSR_AI_ENGINE_CONTROL_SIZE 1
#define CSR_AI_ENGINE_STATUS_ADDR (CSR_BASE + 0x4L)
#define CSR_AI_ENGINE_STATUS_SIZE 1
#define CSR_AI_ENGINE_INPUT_ADDR_ADDR (CSR_BASE + 0x8L)
#define CSR_AI_ENGINE_INPUT_ADDR_SIZE 1
#define CSR_AI_ENGINE_INPUT_DATA_ADDR (CSR_BASE + 0xcL)
#define CSR_AI_ENGINE_INPUT_DATA_SIZE 1
#define CSR_AI_ENGINE_INPUT_WE_ADDR (CSR_BASE + 0x10L)
#define CSR_AI_ENGINE_INPUT_WE_SIZE 1
#define CSR_AI_ENGINE_OUTPUT_ADDR_ADDR (CSR_BASE + 0x14L)
#define CSR_AI_ENGINE_OUTPUT_ADDR_SIZE 1
#define CSR_AI_ENGINE_OUTPUT_DATA_ADDR (CSR_BASE + 0x18L)
#define CSR_AI_ENGINE_OUTPUT_DATA_SIZE 1
...
/* AI_ENGINE Access Functions */
static inline uint32_t ai_engine_control_read(void) {
	return csr_read_simple((CSR_BASE + 0x0L));
}
static inline void ai_engine_control_write(uint32_t v) {
	csr_write_simple(v, (CSR_BASE + 0x0L));
}
static inline uint32_t ai_engine_status_read(void) {
	return csr_read_simple((CSR_BASE + 0x4L));
}
static inline uint32_t ai_engine_input_addr_read(void) {
	return csr_read_simple((CSR_BASE + 0x8L));
}
static inline void ai_engine_input_addr_write(uint32_t v) {
	csr_write_simple(v, (CSR_BASE + 0x8L));
}
static inline uint32_t ai_engine_input_data_read(void) {
	return csr_read_simple((CSR_BASE + 0xcL));
}
static inline void ai_engine_input_data_write(uint32_t v) {
	csr_write_simple(v, (CSR_BASE + 0xcL));
}
static inline uint32_t ai_engine_input_we_read(void) {
	return csr_read_simple((CSR_BASE + 0x10L));
}
static inline void ai_engine_input_we_write(uint32_t v) {
	csr_write_simple(v, (CSR_BASE + 0x10L));
}
static inline uint32_t ai_engine_output_addr_read(void) {
	return csr_read_simple((CSR_BASE + 0x14L));
}
static inline void ai_engine_output_addr_write(uint32_t v) {
	csr_write_simple(v, (CSR_BASE + 0x14L));
}
static inline uint32_t ai_engine_output_data_read(void) {
